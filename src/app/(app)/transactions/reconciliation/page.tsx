...
export default function ReconciliationPage() {
  return (
    <div className="w-full px-4 py-4 sm:px-6">
      <div className="mb-4">
        <h1 className="text-[18px] font-semibold tracking-tight">Reconciliation</h1>
        <p className="mt-0.5 text-[13px] text-muted-foreground">Match financial records and identify exceptions.</p>
      </div>
